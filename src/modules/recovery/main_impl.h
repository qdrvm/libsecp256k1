...
void secp256k1_ecdsa_recoverable_signature_parse_compact_overflow(const secp256k1_context* ctx, secp256k1_ecdsa_recoverable_signature* sig, const unsigned char *input64, int recid) {
    secp256k1_scalar r, s;
